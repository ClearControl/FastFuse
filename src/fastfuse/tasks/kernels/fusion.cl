...
__kernel void fuse_4_imagef_to_imagef(write_only image3d_t dst, read_only image3d_t src1, read_only image3d_t src2, read_only image3d_t src3, read_only image3d_t src4) {
  ...
  float w3 = sobel_magnitude_squared_f(src3,i,j,k);
  float w4 = sobel_magnitude_squared_f(src4,i,j,k);
...
__kernel void fuse_4_imagef_to_imageui(write_only image3d_t dst, read_only image3d_t src1, read_only image3d_t src2, read_only image3d_t src3, read_only image3d_t src4) {
...
__kernel void fuse_4_imageui_to_imageui(write_only image3d_t dst, read_only image3d_t src1, read_only image3d_t src2, read_only image3d_t src3, read_only image3d_t src4) {
...
__kernel void fuse_2_imageui_to_imageui(write_only image3d_t dst, read_only image3d_t src1, read_only image3d_t src2) {
...
__kernel void fuse_2_imagef_to_imagef(write_only image3d_t dst, read_only image3d_t src1, read_only image3d_t src2) {
...
__kernel void fuse_2_imageui_to_imagef(write_only image3d_t dst, read_only image3d_t src1, read_only image3d_t src2) {
